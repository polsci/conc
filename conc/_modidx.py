...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'conc.collocates': { 'conc.collocates.Collocates': ('collocates.html#collocates', 'conc/collocates.py'),
                                 ...
                                 'conc.collocates.Collocates._get_tokens_in_context': ( 'collocates.html#collocates._get_tokens_in_context',
                                                                                        'conc/collocates.py'),
                                 'conc.collocates.Collocates._shift_zeroes_to_end': ( 'collocates.html#collocates._shift_zeroes_to_end',
                                                                                      'conc/collocates.py'),
                                 'conc.collocates.Collocates._zero_after_value': ( 'collocates.html#collocates._zero_after_value',
                                                                                   'conc/collocates.py'),
            ...
            'conc.report': { 'conc.report.Report': ('report.html#report', 'conc/report.py'),
                             ...
                             'conc.report.Report.collocates': ('report.html#report.collocates', 'conc/report.py'),
                             ...
                             'conc.report.Report.keywords': ('report.html#report.keywords', 'conc/report.py'),
                             'conc.report.Report.ngrams': ('report.html#report.ngrams', 'conc/report.py'),
                             'conc.report.Report.set_reference_corpus': ('report.html#report.set_reference_corpus', 'conc/report.py')},
