...
def frequencies(self: Report,
				n:int|None=None, # number of rows to return
				show_token_id:bool=False, # show token_id in output
				normalize_by:int|None=None, # normalize frequencies by a number (e.g. 10000)
				sort_by='frequency', # TODO - check if needed
				) -> Result: # return a Result object with the frequency table
	""" Report frequent tokens. """
	return self.frequency_.frequencies(n=n, show_token_id=show_token_id, normalize_by=normalize_by, sort_by=sort_by)
